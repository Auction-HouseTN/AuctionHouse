<template>
  <div>
    <NavbarEvent />
      ...
      <h1 id="titlesell">welcom to our coin store</h1>
      <button v-on:click="pay(1000)" class="button">
  <span class="button__text">
    <span>Sell 1000 Coins</span>
  </span>
 ...
 <button v-on:click="pay(10000)" class="button">
  <span class="button__text">
    <span>Sell 10000 Coins </span>
  </span>
  <svg class="button__svg" role="presentational" viewBox="0 0 600 600">
    <defs>
      <clipPath id="myClip">
 ...
 <button v-on:click="pay(100000)" class="button">
  <span class="button__text">
    <span>Sell 100000</span>
  </span>
  <svg class="button__svg" role="presentational" viewBox="0 0 600 600">
    <defs>
      <clipPath id="myClip">
